        ...
        <div class="card px-3 py-3" >
            <form action="" method="post">
                <div class="mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="nik" name="nik" placeholder="Misal : 007" required>
                </div>
                <div class="mb-3 mt-3">
                    <label for="name" class="form-label">Nama</label>
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Misal : Laksamana Yi Shun Shin" required>
                </div>
                <div class="mb-3 mt-3">
                ...
                <label class="form_label">Status Karyawan</label>
                <div class="mb-3 mt-3">
