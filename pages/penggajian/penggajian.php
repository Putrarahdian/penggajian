<div id="top" class="row mb-3 ">
    ...
    <div class="col">
        ...
        <div class="col">
            <a href="?page=bultah" class="btn btn-primary float-end me-2" >
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                        <tr class="align-middle">
                            ...
                            <td>
                                <a href="?page=bultahpus&id=<?= $row["id"] ?>&bulan<?= $bulan ?>&tahun<?= $tahun ?>" 
                                onlcick="javascript: return confirm('Konfirmasi data akan di hapus?');"
